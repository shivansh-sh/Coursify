...
<h2 style={{ display: "flex", justifyContent: "center", marginLeft: 10,  fontFamily: 'monospace', fontWeight: 700, letterSpacing: '.2rem'}}>Register an Admin Account</h2>
        <div style={{
            padding: 10
        }}>
        ...
        <div style={{
            ...
            <Button style={{ width: "90px"}} variant="outlined" 
                onClick={() => {
                    fetch("https://localhost:4000/admin/signup", 
                    {
                        method: "POST",
                        body: JSON.stringify({
                            username : email,
